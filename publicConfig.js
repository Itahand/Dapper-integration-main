...
const nonFungibleTokenAddress =
  process.env.NEXT_PUBLIC_NONFUNGIBLE_TOKEN_ADDRESS;
if (!nonFungibleTokenAddress)
  throw "Missing NEXT_PUBLIC_NONFUNGIBLE_TOKEN_ADDRESS";
...
const fungibleTokenSwitchboardAddress =
  process.env.NEXT_PUBLIC_FUNGIBLE_TOKEN_SWITCHBOARD_ADDRESS;
if (!fungibleTokenSwitchboardAddress)
  throw "Missing NEXT_PUBLIC_FUNGIBLE_TOKEN_SWITCHBOARD_ADDRESS";
